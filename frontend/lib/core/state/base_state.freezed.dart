...
mixin _$BaseState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            String message, Object? error, StackTrace? stackTrace, T? data)
        error,
  }) =>
...
abstract class _Initial<T> extends BaseState<T> {
...
abstract class _$$ErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String message, Object? error, StackTrace? stackTrace, T? data});
}
...
class _$ErrorImpl<T> extends _Error<T> {
  ...
  @override
  String toString() {
    return 'BaseState<$T>.error(message: $message, error: $error, stackTrace: $stackTrace, data: $data)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return error(message, this.error, stackTrace, data);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(message, this.error, stackTrace, data);
  }
